...
public class UserViewProfilMecano extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_view_profil_mecano);
        ...
        try{
            String oldStr = usernameSaved;
            String delStr = "Nom du mécanicien : ";

            usernameSaved = oldStr.replace(delStr, "");
    ...
    public class LoadMecanoProfil extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserViewProfilMecano.this);
